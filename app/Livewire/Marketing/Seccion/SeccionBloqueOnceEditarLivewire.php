...
class SeccionBloqueOnceEditarLivewire extends Component
{
    public $seccion;
    ...
    #[On('handleBloque11EditarOn')]
    public function handleBloque11EditarOn($item, $position)
    {
    ...
    #[On('eliminarSeccion11On')]
    public function eliminarSeccion11On()
    {
        if ($this->seccion) {
            $this->seccion->delete();

            return redirect()->route('admin.seccion.bloque-once.vista.todo');
        }
    }

    public function render()
    {
        return view('livewire.marketing.seccion.seccion-bloque-once-editar-livewire');
    }
}
