...
class SeccionBloqueDosEditarLivewire extends Component
{
    public $seccion;
    ...
    public function mount($id)
    {
        ...
        $this->imagen = $this->lista = $contenido['imagen'];
    ...
    #[On('handleBloque2EditarOn')]
    public function handleBloque2EditarOn($item, $position)
    {
    ...
    {
        return view('livewire.marketing.seccion.seccion-bloque-dos-editar-livewire');
    }
}
