...
class SeccionBloqueOnceCrearLivewire extends Component
{
    public $nombre;
    ...
    #[On('handleBloque11CrearOn')]
    public function handleBloque11CrearOn($item, $position)
    {
    ...
    {
        return view('livewire.marketing.seccion.seccion-bloque-once-crear-livewire');
    }
}
