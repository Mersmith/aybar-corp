...
class SeccionBloqueSieteCrearLivewire extends Component
{
    public $nombre;
    ...
    #[On('handleBloque7CrearOn')]
    public function handleBloque7CrearOn($item, $position)
    {
    ...
    {
        return view('livewire.marketing.seccion.seccion-bloque-siete-crear-livewire');
    }
}
