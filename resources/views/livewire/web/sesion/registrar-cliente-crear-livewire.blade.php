            ...
            <form wire:submit.prevent="registrar" class="formulario_flex formulario">
                ...
                <div class="g_margin_top_20">
                    <label>
                        ...
                        <span>He leído y acepto el <a href=""> <u>Tratamiento de mis datos personales</u>. </a></span>
                    </label>
                    @error('politica_uno')
                ...
                <div>
                    <label>
                        ...
                        <span>He leído y acepto la <a href=""> <u>Política para envío de comunicaciones comerciales</u>.
                            </a></span>
                    </label>
                    @error('politica_dos')
                    <p class="mensaje_error">{{ $message }}</p>
