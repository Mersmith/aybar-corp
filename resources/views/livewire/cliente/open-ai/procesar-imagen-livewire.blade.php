    ...
    @else
        ...
        @if ($imagen)
            <div class="resultados_grid">
                <div class="preview">
                    <button class="g_boton_cerrar" wire:click="eliminarImagen"><i
                ...
                <div class="g_gap_pagina">
                    ...
                    <div class="formulario">
                        ...
                        <div class="formulario_botones">
                            @if (!$datos)
                                <button wire:click="procesarImagen" class="g_boton_personalizado verde"
                                    wire:loading.attr="disabled" wire:target="procesarImagen">
