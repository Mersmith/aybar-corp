@section('tituloPagina', 'Formulario landing')
                ...
                <table class="tabla">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="g_resaltar">{{ $item->apellido }}</td>
                            <td class="g_resaltar">{{ $item->email }}</td>
                            <td class="g_resaltar">{{ $item->telefono }}</td>
                            <td class="g_inferior g_resumir">{{ $item->asunto }}</td>
                            <td class="g_inferior g_resumir">{{ $item->mensaje }}</td>
                            <td>
                            ...
                            <td class="centrar_iconos">
                                <a href="{{ route('admin.formulario-landing.vista.editar', $item) }}"
