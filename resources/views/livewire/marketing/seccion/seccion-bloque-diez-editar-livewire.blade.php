@section('tituloPagina', 'Editar bloque 10')
@section('anchoPantalla', '100%')

<div x-data="dataBloque10Editar()" class="g_gap_pagina">

    <!-- CABECERA -->
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar bloque 10</h2>
        ...
        <div class="cabecera_titulo_botones">
            ...
            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarBloque10()">
        ...
        <div class="g_fila">
            ...
            <div class="g_columna_8 g_gap_pagina">
                ...
                <div class="g_panel">
                    ...
                    <!-- LISTA -->
                    <div x-sort="handleBloque10Editar" class="g_gap_pagina">
    ...
    <script>
        function dataBloque10Editar() {
            return {
                ...
                handleBloque10Editar(item, position) {
                    Livewire.dispatch('handleBloque10EditarOn', {
                        item,
                        position
                    });
                }
        ...
        function alertaEliminarBloque10() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('eliminarSeccion10On');
