                            ...
                            <form action="{{ route('landing.store') }}" method="POST" class="g_formulario">
                                ...
                                <div class="form_grupo">
                                    <input type="text" name="apellido" placeholder="Apellidos"
                                        value="{{ old('apellido') }}" required minlength="2" maxlength="80"
                                        pattern="[A-Za-zÁÉÍÓÚÑáéíóúñ ]+" title="Solo letras y espacios.">
                                    @error('apellido')
                                        <div class="error-text">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form_grupo">
                                    <input type="text" name="telefono" placeholder="Celular"
                                        value="{{ old('telefono') }}" inputmode="numeric" pattern="[0-9]{9}" minlength="9"
                                        maxlength="9" title="Debe contener 9 dígitos numéricos.">
                                    @error('telefono')
                                        <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
